...
const Electronics = () => {
  ...
  return (
    ...
    <h2 className=" sm:px-4 sm:text-3xl section_title section_title-gradient product_line">
        Electronics  
    </h2>
    ...
    <div className="relative  flex px-6 justify-center items-center text-sm ">
            ...
            <input
              className=" input_bar pl-[25px] w-full h-[30px]  
              rounded-[200px] border-none outline-none "
              type="search"
    ...
    <div className="products_container box grid">
        { filterSearchHandler.map((item :any) =>{
           return  <ProductCard key={item.id} item={item} {...item} />
        })
