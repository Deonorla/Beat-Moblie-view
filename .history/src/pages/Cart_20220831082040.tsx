  ...
  return (
    ...
    <div>
        ...
        <div className='flex justify-between'>
            <h2 className=" ml-12 text-center mt-12 font-semibold text-3xl section_title-gradient product_line">
                Checkout  
            </h2>

                    <button 
                    className="bg-zinc-900 rounded-[4px] w-[3.3rem] h-[3.3rem] text-white text-lg cursor-pointer"
